...
if(isset($_REQUEST["rid"]))
{
  ...
  $_SESSION["rname"]=$_REQUEST["hidden_name"];
}
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Welcome To <?php echo $_SESSION["rname"]; ?></h1>      
...
$sql = "SELECT * FROM FOOD WHERE options = 'ENABLE' and R_ID=".$_SESSION["rid"]." ORDER BY F_ID";
...
<img src="uploads/<?php echo $row["images_path"]; ?>" class="img-responsive" width=250 height=250>
