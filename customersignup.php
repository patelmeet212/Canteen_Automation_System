<html>
<head>
    <title> Guest Signup | Student Canteen </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Student Canteen </span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="cpassword" type="password" name="cpassword" placeholder="Password" required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
            </span>
        ...
        <div class="row">
         ...
         <span style="color:red;font-weight: bold;"><?php isset($_REQUEST["msg"])?print "Confirm Password not matched":print "";?></span>
 <br>
