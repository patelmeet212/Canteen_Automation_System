...
<h2 class="text-center"> Thank you for Ordering at Student Canteen! The ordering process is now complete.</h2>



<h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo $_SESSION["orderno"]; ?></span> </h3>
<?php
