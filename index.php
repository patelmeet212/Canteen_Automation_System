...
<html>
  ...
  <head>
    <title> Home | Student Canteen </title>
...
?>
    ...
    <div class="wide" style="background-image: url('images/headerimg1.jpg');background-size:cover;">
      	<div class="col-xs-5 line"><hr></div>
        <div class="col-xs-2 logo"><img src="images/LogoImage.jpg"></div>
        <div class="col-xs-5 line"><hr></div>
        <div class="tagline">Welcome to the Delicious Treat!</div>
    </div>
    <br>
