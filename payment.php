...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (order_ID,F_ID, foodname, price,  quantity, order_date, username, R_ID) 
              VALUES ('" . $orderno."','". $F_ID . "','" . $foodname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
